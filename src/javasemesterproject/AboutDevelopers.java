...
public class AboutDevelopers extends JFrame{
    ...
    public AboutDevelopers() {
        ...
        String[][] rowData = {{"195020900037", "TATHAGAT", "<html>Modules Development<html>"}, 
                               {"195020900037", "TATHAGAT", "<html>Modules Integration<br/> and Code Refinement</html>"}, 
                               {"195020900018", "NADIM ANSARI", "<html>Database Connectity<br/> and Design</html>"}};
        String columns[] = {"Roll No", "Name", "Contributions"};
